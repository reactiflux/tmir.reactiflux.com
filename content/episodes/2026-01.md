...
transistorId: 14c53957
audioUrl: https://op3.dev/e/media.transistor.fm/14c53957/41e53c05.mp3
duration: 3956
season: 3
episode: 1
---

- [[00:00:58](#new-releases)] New releases
  - [[00:00:59](#next-161-turbopack-updates-bundle-analyzer)] [Next 16.1](https://nextjs.org/blog/next-16-1) (Turbopack updates, bundle analyzer)
    - [[00:01:15](#turbopack-incremental-computation)] [Turbopack incremental computation](https://nextjs.org/blog/turbopack-incremental-computation)
  - [[00:01:38](#react-navigation-80-alpha)] [React Navigation 8.0 alpha](https://reactnavigation.org/blog/2025/12/19/react-navigation-8.0-alpha/)
  - [[00:02:03](#rn-windows-081-with-new-arch-support)] [RN Windows 0.81 with New Arch support](https://devblogs.microsoft.com/react-native/%F0%9F%9A%80react-native-windows-v0-81-is-here/)
    - [[00:02:55](#state-of-react-native-macos-saad-najmi-jay-meistrich)] [State of React Native macOS](https://www.youtube.com/watch?v=XE7yKGDsy9g) Saad Najmi & Jay Meistrich
  - [[00:03:15](#mark-josh-goldbergs-new-flint-linter)] Mark: Josh Goldberg’s [new Flint linter](https://www.flint.fyi/blog/introducing-flint)
  - [[00:05:15](#immer-111-array-methods-override)] [Immer 11.1](https://github.com/immerjs/immer/releases/tag/v11.1.0) (array methods override)
  - [[00:06:37](#rolldown-10-rc)] [Rolldown 1.0 RC](https://voidzero.dev/posts/announcing-rolldown-rc)
  - [[00:06:54](#yarn-6-preview)] [Yarn 6 Preview](https://yarn6.netlify.app/blog/2026-01-28-yarn-6-preview/)
  - [[00:07:42](#vite-plus)] [Vite Plus](https://viteplus.dev/)
  - [[00:08:59](#new-css-grid-lanes-masonry-feature-spec-nailed-down)] [New “CSS Grid Lanes” (“masonry”) feature spec nailed down](https://webkit.org/blog/17660/introducing-css-grid-lanes/)
  - [[00:10:39](#temporal-api-finally-hitting-stability-and-how-it-replaces-dates-)] [Temporal API finally hitting stability](https://developer.chrome.com/blog/new-in-chrome-144#temporal) ([and how it replaces Dates](https://piccalil.li/blog/date-is-out-and-temporal-is-in/) )
- [[00:12:29](#main-content)] Main Content
  - [[00:12:34](#react-core)] React Core
    - [[00:12:37](#additional-updates-cves-for-dos-as-of-jan-26-update-to-1905-1915-and-1924)] [Additional updates / CVEs for DoS](https://react.dev/blog/2025/12/11/denial-of-service-and-source-code-exposure-in-react-server-components) as of Jan 26 . Update to 19.0.5, 19.1.5, and 19.2.4
    - [[00:13:40](#nextjs-dos-cves-for-image-optimizer-and-partial-pre-rendering)] [Next.js DoS CVes](https://vercel.com/changelog/summaries-of-cve-2025-59471-and-cve-2025-59472) for Image Optimizer and Partial Pre-Rendering
    - [[00:13:50](#react-docs-updates-for-useoptimistic-and-useeffectevent)] React docs updates for [useOptimistic](https://github.com/reactjs/react.dev/pull/8264) and [useEffectEvent](https://github.com/reactjs/react.dev/pull/8279)
    - [[00:14:11](#and-this-post-on-useoptimistic-issues)] And this post on [useOptimistic issues](https://www.columkelly.com/blog/use-optimistic)
    - [[00:14:32](#sparked-by-dan-raising-concerns-about-the-docs-quality)] Sparked by [Dan raising concerns](https://bsky.app/profile/danabra.mov/post/3mciooa25gc2v%20) about the docs quality
    - [[00:16:57](#ai-meets-rn-panel-discussion)] [AI meets RN Panel Discussion](https://www.youtube.com/watch?v=QX1a6I08o-A)
    - [[00:17:17](#work-on-the-gesture-api-and-view-transitions-and-fragment-refs-canary-only)] Work on the [Gesture API and View Transitions](https://github.com/facebook/react/pull/35564), and [Fragment Refs](https://github.com/facebook/react/pull/35630) (canary only)
    - [[00:18:29](#viewtransition-underlying-tech-is-now-supported-in-all-major-browsers-as-of-firefox-147-react-features-is-still-in-canary)] [\<ViewTransition\> underlying tech](https://developer.mozilla.org/en-US/docs/Web/API/ViewTransition/types) is now supported in all major browsers as of Firefox 147. React features is still in Canary.
    - [[00:19:22](#jordan-pred-the-actual-usestore-concurrent-store-impl-for-react)] Jordan PRed [the actual `useStore` concurrent store impl for React](https://github.com/facebook/react/pull/35449)
    - [[00:20:54](#types-changes-to-improve-form-events)] [Types changes to improve form events](https://github.com/DefinitelyTyped/DefinitelyTyped/pull/74383)
  - [[00:21:34](#other-security-issues)] Other security issues
    - [[00:21:39](#react-router-cves-meta-xss-file-access-external-redirects-csrf)] [React Router CVEs](https://bsky.app/profile/reactrouter.com/post/3mbwtrea3r224): meta XSS, file access, external redirects, CSRF
    - [[00:23:17](#node-security-releases)] [Node security releases](https://nodejs.org/en/blog/vulnerability/december-2025-security-releases)
    - [[00:24:38](#lodash-security-releases)] [Lodash security releases](https://openjsf.org/blog/lodash-security-overhaul)
      - [[00:24:46](#funded-by-a-european-effort-to-fund-projects-for-sovereign-resiliency)] [Funded by a european effort](https://www.sovereign.tech/programs/fund) to fund projects for sovereign resiliency
    - [[00:25:35](#githubs-announced-plans-on-security-improvements)] [Github’s announced plans on security improvements](https://github.blog/security/supply-chain-security/strengthening-supply-chain-security-preparing-for-the-next-malware-campaign/)
    - [[00:27:48](#summary-of-npms-publishing-changes-and-requests-for-improvements)] [Summary of NPM’s publishing changes](https://socket.dev/blog/npm-to-implement-staged-publishing), and requests for improvements
  - [[00:28:28](#claude-skills-in-the-react-world)] Claude Skills in the React world
    - [[00:28:49](#announcement-by-anthropic)] [Announcement by Anthropic](https://claude.com/blog/equipping-agents-for-the-real-world-with-agent-skills)
      - [[00:29:16](#open-sourced)] [Open sourced](https://agentskills.io/home)
    - [[00:29:53](#vercel-react-best-practices)] Vercel: [React Best Practices](https://vercel.com/blog/introducing-react-best-practices)
    - [[00:30:47](#expo-claude-code-pluginskill)] [Expo Claude Code Plugin/Skill](https://x.com/Baconbrix/status/2011862532320084329)
    - [[00:32:23](#agents-worked-better-than-skills)] [“AGENTS worked better than skills”](https://vercel.com/blog/agents-md-outperforms-skills-in-our-agent-evals)
    - [[00:40:42](#moltbook-aka-openclaw)] [Moltbook](https://www.moltbook.com/), aka [OpenClaw](https://openclaw.ai/)
    - [[00:43:09](#remotion-ai-skill)] [Remotion AI Skill](https://x.com/Remotion/status/2013626968386765291)
  - [[00:43:49](#rsc-roundup)] RSC roundup
    - [[00:43:52](#data-fetching-patterns-in-rscs)] [Data Fetching Patterns in RSCs](https://gauravthakur.com/blog/data-fetching-patterns-react-server-components)
    - [[00:44:14](#nadias-can-you-fetch-data-with-server-actions)] [Nadia’s Can You Fetch Data with Server Actions?](https://www.developerway.com/posts/server-actions-for-data-fetching)
    - [[00:44:31](#infiniterenders-takes-on-partial-pre-rendering-and-app-router-complexity)] “Infiniterenders” takes on [Partial Pre-Rendering](https://x.com/infinterenders/status/2007670332362989569) and [App Router complexity](https://x.com/infinterenders/status/2007670332362989569)
    - [[00:45:03](#rebuilding-github-prs-with-rscs-same-author-who-did-issues-previously)] [Rebuilding Github PRs with RSCs](https://wtbb.vercel.app/i-love-dogs) (same author who did Issues previously)
  - [[00:46:01](#ecosystem-economics)] Ecosystem economics
    - [[00:46:07](#astro-acquired-by-cloudflare)] [Astro acquired by CloudFlare](https://astro.build/blog/joining-cloudflare/)
    - [[00:47:32](#tailwind-revenue-down-80-in-the-ai-era-laid-off-3-of-4-devs-working-there)] [Tailwind revenue down 80% in the AI era, laid off 3 of 4 devs working there](https://github.com/tailwindlabs/tailwindcss.com/pull/2388#issuecomment-3717222957)
    - [[00:50:15](#voidzero-and-vite)] VoidZero and Vite\+?
    - [[00:52:22](#246k-laid-off-in-2025-per-trueupio-27k-in-january)] [246K laid off in 2025 per Trueup.io](http://Trueup.io), 27k in January
- [[00:52:56](#-lightning-round-)] ⚡ Lightning round ⚡
  - [[00:52:57](#corbin-adapting-library-logic-for-react-compiler)] Corbin: [Adapting Library Logic for React Compiler](https://playfulprogramming.com/posts/react-compiler-library-support/)
  - [[00:53:11](#lea-verou-web-dependencies-are-broken)] [Lea Verou: Web Dependencies are Broken](https://lea.verou.me/blog/2026/web-deps/)
  - [[00:53:47](#aws-infrastructure-as-react-components)] [AWS Infrastructure as React Components](https://www.react2aws.xyz/)
  - [[00:54:38](#callstack-releasing-bunch-of-cool-projects)] Callstack releasing bunch of cool projects
  - [[00:54:48](#brownie-rn-brownfield-apps)] [Brownie: RN Brownfield apps](https://www.callstack.com/blog/introducing-brownie-type-safe-shared-state-for-react-native-brownfield-apps)
  - [[00:55:17](#voltra-rn-live-activities-and-widgets)] [Voltra: RN Live Activities and Widgets](https://www.callstack.com/blog/live-activities-and-widgets-with-react-say-hello-to-voltra)
  - [[00:56:12](#ryan-carniatos-annual-js-frameworks-direction-roundup-and-netlifys-2025-web-frameworks-in-review)] Ryan Carniato’s [annual JS Frameworks direction roundup](https://dev.to/this-is-learning/javascript-frameworks-heading-into-2026-2hel) , and Netlify’s [2025 Web Frameworks In Review](https://www.netlify.com/blog/web-frameworks-2025-year-in-review/)
  - [[00:56:36](#alex-russell-shallow-session-spas-analytics)] Alex Russell: [Shallow Session SPAs analytics](https://calendar.perfplanet.com/2025/the-curious-case-of-the-shallow-session-spas/)
  - [[00:57:23](#devon-govett-how-to-compile-js-to-c-with-static-hermes)] Devon Govett: [How to compile JS to C with Static Hermes](https://devongovett.me/blog/static-hermes.html)
  - [[00:58:16](#joyee-cheung-requireesm-implementers-tales-and-requireesm-from-experiment-to-stability)] Joyee Cheung: [require(esm) implementer’s tales](https://joyeecheung.github.io/blog/2025/12/30/require-esm-in-node-js-implementers-tales/) and [require(esm) from experiment to stability](https://joyeecheung.github.io/blog/2025/12/30/require-esm-in-node-js-from-experiment-to-stability/)
  - [[00:58:53](#fixing-the-url-params-performance-penalty)] [Fixing the URL Params Performance Penalty](https://calendar.perfplanet.com/2025/fixing-the-url-params-performance-penalty/)
...
**Carl Vitullo:** Hello everyone. Thank you for joining us for the first this month in React of 2026 January edition. As we recap what's going on in React, react Native and across the web, we're coming to you live from Reactiflux, the place for professional developers using React. [00:00:00]
...
**Mark Erikson:** Hi, I'm Mark. My day job is working at Replay. My second unpaid job is working on Redux and I'm not wearing glasses. [00:00:25]

**Carl Vitullo:** Yeah. Congrats on LASIK! [00:00:33]

**Mo Javad:** And I'm Mo I'm the head of Mobile at Thero. I'm an active part of the React Native community, and I organize the React Native London Meetup and Conference. [00:00:35]

**Carl Vitullo:** and like 10 minutes fresh off, traveling back home. Right? [00:00:43]

**Mo Javad:** yeah. Just got home. Just got home. I'm still still wearing my coat. [00:00:48]

**Mark Erikson:** Make yourself comfortable. [00:00:52]

**Mo Javad:** We're gonna be here. [00:00:54]

**Carl Vitullo:** Cool. Okay. Uh, Let's get straight into some new releases. [00:00:55]

## New releases

**Carl Vitullo:** Yeah, Mark, take us through those. [00:00:58]

## [Next 16.1](https://nextjs.org/blog/next-16-1) (Turbopack updates, bundle analyzer)

**Mark Erikson:** Okay. Item one we have next. 16.1 just came out not a lot. Huge. There, there's some improvements to Turbo pack. They have a new bundle analyzer feature built in. I'm always in favor of, you know, actually understanding what's going into your system. [00:00:59]

## [Turbopack incremental computation](https://nextjs.org/blog/turbopack-incremental-computation)

**Mark Erikson:** Looks like some of the Turbo Pack file caching stuff ought to make the dev mode a little bit faster. [00:01:15]
...
**Mo Javad:** And then the next one is React Native Windows, version 0.81. Is out. And the same is actually the case with React Native Mac Os because they're both maintained by Microsoft. [00:02:03]
...
**Mark Erikson:** I would love to know what the adoption numbers are for either the, the macro windows ports outside of Microsoft. Early outta curiosity, [00:02:37]

**Mo Javad:** It's not as well publicized or showcased, but I have a great talk, which I'm gonna use this opportunity to plug by one of the maintainers. [00:02:46]

## [State of React Native macOS](https://www.youtube.com/watch?v=XE7yKGDsy9g) Saad Najmi & Jay Meistrich

**Mo Javad:** so this was at the conference that we hosted at Arn Lko and one of the maintainers, one of the maintainers of React Native macOS did a joint talk with Jay Meistrich, who maintains Legend List. And they talked about react Native macOS in the state of React Native Macs. It's a very cool talk to get an idea of what's in store. So, [00:02:55]

**Carl Vitullo:** great. Love that. [00:03:13]

## Mark: Josh Goldberg’s [new Flint linter](https://www.flint.fyi/blog/introducing-flint)

**Mark Erikson:** All right. Next item. Josh Goldberg is a wonderful one. Wonderful human being if you ever had a chance to talk to him. He's also a major proficient linting tool maintainer. He's been the primary maintainer of TSES lint. He's worked on a number of other linting projects. He's had a lot of interactions with the ES lint maintainers and the TypeScript maintainers. [00:03:15]
...
**Carl Vitullo:** Yeah, if you're gonna complain about something, putting your money where your mouth is on investing the energy to try and execute on those gripes is something that I would love to see everybody try and do. [00:05:03]

## [Immer 11.1](https://github.com/immerjs/immer/releases/tag/v11.1.0) (array methods override)

**Mark Erikson:** A personal item and one that I've been, you know, waiting to see come together for a while. So those of you who have been paying attention to the podcast over the last few months have heard me talk about the performance optimization work I did on Emer in September and October. [00:05:15]
...
**Mark Erikson:** Couple other items. [00:06:37]
...
**Mark Erikson:** think a lot of the debate there was should this become like another named CSS display mode or is this another set of options for grid or something else? What's the naming, how does it play with the existing layouts? And so there, there was a lot of discussion iteration to try to figure out what the right approach was there. [00:10:13]

**Carl Vitullo:** And it sounds like they have, or at least close enough to where there's something has been shipped, which is great. Cool. [00:10:33]
...
**Carl Vitullo:** Other, not quite released, but major progress .Temporal has been released in Chrome, I believe in the main release branch Chrome 1 [00:10:39]

**Mark Erikson:** I think this, this is actually out. [00:10:49]

**Carl Vitullo:** yeah. [00:10:51]
...
**Mark Erikson:** And interesting implementation. I, I only saw this in passing, but I think the actual core of the temporal implementation that Chromium is using is indeed in rust and then exposed up through the JS engine. [00:12:11]

**Carl Vitullo:** fascinating. Cool. [00:12:24]

**Mark Erikson:** I'd have to go back and double check details, but I think I saw it somewhere. [00:12:25]

**Carl Vitullo:** Okay. Neat. [00:12:28]

## Main Content

**Carl Vitullo:** That's all the new releases we got for you. Let's go into main content [00:12:29]

**Mark Erikson:** Okay. [00:12:33]

## React Core

**Mark Erikson:** A number of items from around the React core area. [00:12:34]
...
**Carl Vitullo:** Yep. Geez, not ideal. [00:13:38]
...
**Mark Erikson:** these for their own internal pieces image optimizer and partial pre rendering. So again, please update your next JS to the latest as well. [00:13:40]
...
**Carl Vitullo:** Yeah. That's interesting. I was, I've been curious, you know, I've never worked at big companies. I generally understand them to be pretty touchy about stuff like uploading code to third party servers. [00:16:10]
...
**Mo Javad:** It's quite interesting that like they're kind of allowed to almost come and say it publicly, given that Meta has been a big advocate of their own sort of open source models. Like, so, you know, it's almost like, hey, we use the direct competitors tools and it's, you know, it's fine. You know, so I think that's quite interesting. [00:16:35]

## [AI meets RN Panel Discussion](https://www.youtube.com/watch?v=QX1a6I08o-A)

**Mo Javad:** We actually had some people from the React Native Core team where we talked about this at the conference. So I'm gonna do another, I'm gonna be doing a lot of self [00:16:57]

**Mark Erikson:** Please plug your stuff. [00:17:02]

**Mo Javad:** yes. It's not really my stuff. I mean, I was I was moderating the panel, but I, if you want to get a little bit of insight into what the React Native Core team does with ai, this might be an interesting panel for you to watch. [00:17:05]

We have a really good chat. [00:17:15]

**Mark Erikson:** Cool. [00:17:16]
...
**Mark Erikson:** Meanwhile, in the midst of all the CVEs and everything else the React team is continuing to work on actual core functionality. We had the view transitions, alpha APIs came out last year, and Sebastian Markbåge has continued working on that and is expanding the view transition support with relation to gestures and some other animation things as well. [00:17:17]
...
**Carl Vitullo:** Can confirm, fragment refs are canary only right now. [00:18:24]

**Mark Erikson:** okay. Okay. So still work in progress. [00:18:27]
...
**Mark Erikson:** And last item there was a types PR put up and I think possibly actually merged to improve the react types around form events. Trying to get better typing for the target field, I believe. [00:20:54]

**Carl Vitullo:** It did get merged. Can I confirm? [00:21:07]

**Mark Erikson:** cool. [00:21:10]

**Carl Vitullo:** So it looks like the form event had previously been matched on types to the React synthetic event. But it was not identical to the actual DOM event. And so this types change corrects that. So the the types are now matching what is in the dom it looks like. Cool. Looks great. [00:21:11]

**Mark Erikson:** Yep. And that's it from the roundup around the world of the core. [00:21:28]

**Carl Vitullo:** Heck yeah. Cool. [00:21:32]

## Other security issues

**Carl Vitullo:** Let's go back into some more security issues around the ecosystem. [00:21:34]

## [React Router CVEs](https://bsky.app/profile/reactrouter.com/post/3mbwtrea3r224): meta XSS, file access, external redirects, CSRF

**Carl Vitullo:** Yeah. I guess we briefly touched on some. You know, CVEs and other, you know, denial of service vulnerabilities. In next react Router has also put up a thread discussing six CVEs. It says they publish six CVEs identifying vulnerabilities between React router and remix B two. [00:21:39]
...
**Carl Vitullo:** node likewise also had a, couple of security patches also pretty deep in the weeds. Several of these I believe, were uncovered as a result of investigations started after the React CVEs last month. [00:23:18]
...
**Carl Vitullo:** Here's a name I haven't thought of in a minute. Lodash they rolled out a major security overhaul as this blog post titles it. [00:24:38]

## [Funded by a european effort](https://www.sovereign.tech/programs/fund) to fund projects for sovereign resiliency

**Carl Vitullo:** An interesting detail that I, I noticed while reading the blog post, it was actually funded by a sovereign tech agency is what it's called. And it says that they're, we invest globally in the open software components that underpin Germany and Europe's competitiveness and ability to, to innovate. [00:24:46]
...
**Carl Vitullo:** Moving on a bit. GitHub put out a blog post towards the end of last month. I think we missed it because we recorded early in December to avoid the holidays. But they put out a blog post about strengthening supply chain security, just across GitHub and NPM. [00:25:35]
...
**Mark Erikson:** the biggest issue is I've now done this for a couple packages and you have to go in directly into the NPM settings for that package. Manually click through. I want to turn on trusted publishing for this package. Here's the repo name, the, YML file that will publish this and confirm the settings. [00:26:16]
...
**Mo Javad:** So, Vercel very quickly jumped in and you know, I think earlier this month released a React best practices skill. So they basically created a whole bunch of different rules. Things like, you know, when you [00:29:53]

**Mark Erikson:** Don't set state and use effect. Da, da, da, da. [00:30:08]

**Mo Javad:** Saving in the day. Yeah, exactly. All of that stuff. [00:30:12]
...
**Mark Erikson:** 200 k usually. [00:34:35]

**Mo Javad:** for both the open AI models and the philanthropic models. [00:34:36]
...
**Mark Erikson:** I think that was all of the skills in a sort of compressed format. [00:35:09]

**Mo Javad:** Interesting. So that's quite interesting because the research that I've read about LMS and how they act is like you want to keep the context as small as possible [00:35:14]
...
**Carl Vitullo:** this is validating for me because I have skipped past a lot of the, like MCPs and whatever. 'cause I looked at them and it's like, oh, this is just a docs query with way more extra ceremony around it. I'm just gonna write my own markdown doc and point it at it. [00:39:14]
...
**Mark Erikson:** talking to each other. [00:42:26]

**Mo Javad:** Instances, talking to each other, sharing posts, trying to improve each other. [00:42:27]
...
**Mark Erikson:** Rolling very quickly through a few RRSC related things. [00:43:49]

## [Data Fetching Patterns in RSCs](https://gauravthakur.com/blog/data-fetching-patterns-react-server-components)

**Mark Erikson:** Saw a very good post on some different data fetching patterns for server components. Very helpful background on, you know, like how dealing with data in server components differs from doing on the client side. Tips for, you know, how do you fetch data in a server component? How do you pass a promise to the client side to use it? Very useful. Frankly. This is the kind of thing that'd be great to see in the React docs. [00:43:52]

## [Nadia’s Can You Fetch Data with Server Actions?](https://www.developerway.com/posts/server-actions-for-data-fetching)

**Mark Erikson:** I think something, related to that uh, Nadia Makarevich put out another great deep dive exploratory post on can you fetch data in server actions. And I think her conclusion was technically yes, you probably shouldn't do that. This is not what the hammer is meant for. [00:44:14]
...
**Carl Vitullo:** Love that. I will say I pointed it at one of my prs and it just 404s, so I don't know, I don't know if I'm loading it wrong or I don't know if it's relying on like pre-cached stuff or what, but yeah it's not, its not working for me. It's fast. It's fast. When I load up something that does work, it's pretty fast. But yeah. Cool. [00:45:39]

## Ecosystem economics

**Mark Erikson:** Can make a quick spin through the ecosystem thing [00:46:01]

**Carl Vitullo:** yeah. Okay, cool. a little bit of ecosystem, economics, whatever. [00:46:03]

## [Astro acquired by CloudFlare](https://astro.build/blog/joining-cloudflare/)

**Carl Vitullo:** We referenced some of this earlier, but Astro got acquired by CloudFlare. That's a bit of a surprise. I saw some discussion of it from people I respect who are like, but why? I, [00:46:07]

**Mark Erikson:** money. [00:46:19]

**Carl Vitullo:** Astro's great. It's very cool. [00:46:19]
...
**Mark Erikson:** The same thing with tailwind. [00:47:27]

**Carl Vitullo:** Right. And here's a contrasting example. [00:47:29]
...
**Mo Javad:** What I did read afterwards was apparently they did get a bit of sponsorship coming in from a bunch of different ecosystem players, which was good. I'm glad that [00:48:43]

**Carl Vitullo:** Yeah. Oh, that's true. That's true. to summarize some of the story for Tailwind here. Somebody opened a PR saying, let's add an AI documentation URL, llms.txt, to make it easier for LLMs to understand how to use this. And in response uh, the maintainer said like, I don't really wanna do this. AI is crippling our business. We just had to lay off three of the four people who work on it, and our revenue has dropped 80%. [00:48:50]

**Mark Erikson:** And I think all, and I think also put up a big podcast then saying like, this sucks. Here's what we've been having to go through. [00:49:13]

**Carl Vitullo:** Right, right. Podcast in the form of, I think just, I think it was what Adam walks, it was like he walks around while musing into a microphone, which I love. And so like that went viral and they got a bunch of sponsorship and, you know, income through that after they laid people off, unfortunately did not save those people's jobs. [00:49:20]
...
**Mark Erikson:** It's certainly not a repeatable and reliable business model. [00:49:59]

**Carl Vitullo:** I'm very happy that Tailwind got more revenue after talking about how much their revenue has dropped. But like, that's not gonna ha that's not gonna happen for everybody who needs it and it's not gonna happen repeatedly. So me, [00:50:02]

## VoidZero and Vite+?

**Mo Javad:** leads back to that void zero v plus story, which is, I don't see a viable path for monetization for open source projects. It's oftentimes it actually doesn't end up being that successful. I, I mean, mark. Mark, you've been in the ecosystem far more than any of us, I guess, just by virtue of being a successful open source maintainer, but you know, you've obviously done that on the side. [00:50:15]

Right? And like, can you think of any projects that have been successful, like uber successful at monetizing? [00:50:38]

**Mark Erikson:** TanStack's the only one that I can think of. Like talking to Tanner this last year. The sponsorships that he's been pulling in have were enough to allow him to go full-time, open source a couple years ago. And he said that the sponsorships have kept growing to the point where he's, he's able to do some disbursements to some of the other maintainers now, and he hopes that if things keep on this trajectory, he might be able to hire some of them full-time. [00:50:44]

But that's about the only one that immediately comes to mind. [00:51:12]

**Carl Vitullo:** And I think, does he do, do you know if Tanner does? Uh, Like consulting and like services? [00:51:15]

**Mark Erikson:** Think he does some, but it's, I think a lot of it is just straight up sponsorships. [00:51:21]

**Carl Vitullo:** Okay, cool. [00:51:24]

**Mo Javad:** But I guess that's sponsorships, right? Like it's not a direct monetization play, right? So you are relying on the. Donations of, companies in the ecosystem to keep you going. Whereas like, I think the only one I can think of is super base, but they were actually going in for monetization from the get go. [00:51:25]
...
**Carl Vitullo:** I don't know. It's open source has always been tough. It feels like the economics have gotten weirder. It's like, there's more money than ever in tech. You know, as a market, as a, as an industry. But where it is going has is fewer and fewer players. So that's just like, that's tough. I don't know. It's like wealth inequality, open source edition. [00:51:51]

**Mo Javad:** It looks like AI is just making it worse as well, even in like the terms of the tech openings, job openings that are out there and people trying to, companies trying to do more with less people yep. at everything. [00:52:10]

## [246K laid off in 2025 per Trueup.io](http://Trueup.io), 27k in January

**Carl Vitullo:** Which is a wonderful segue into true up.io, which I have previously relied on to, you know, back when I was doing more month by month layoff news according to them, in 2025, 246,000 tech jobs were lost through layoffs. And already in January we're at 27,000 Rough. [00:52:22]

**Mo Javad:** Geez. Which, you know, Amazon had a pretty big one this week. I believe it was thousand people, which was rough. [00:52:43]

**Carl Vitullo:** Yep. Yep. I dunno what to do with that. [00:52:52]

## ⚡ Lightning round ⚡

**Mark Erikson:** Lightning round. [00:52:56]

## Corbin: [Adapting Library Logic for React Compiler](https://playfulprogramming.com/posts/react-compiler-library-support/)

**Mark Erikson:** TanStack form maintainer Corbin Crutchley. Put out a post talking on adapting library code to work properly with the React compiler and some of the constraints that you have to deal with Corbin's. [00:52:57]

Awesome. This is a very useful post. [00:53:09]

## [Lea Verou: Web Dependencies are Broken](https://lea.verou.me/blog/2026/web-deps/)

**Mark Erikson:** Lea Verou, who has been in the web standards and CSS discussion, spec specification arena for a very, very long time. Put a proposed complaining about web dependencies are broken. I'm not sure I agree with some of the complaints here, but she's very clearly spent a lot of time complaining about the fact that there's a lot, essentially a lot of non-standardized ways to deal with dependencies. [00:53:11]
...
**Mo Javad:** I posted this on our company dev chat and someone respond, did one misconfigured use effect. And Gigi, you're bankrupt. [00:54:29]

**Mark Erikson:** Worse than the cloud dashboard. [00:54:36]

## Callstack releasing bunch of cool projects

**Mo Javad:** Alright, quick react native one. So, uh, the call stack folks have been busy whilst the rest of the ecosystem I'd say has been relatively quiet. This month and they've released two really cool projects. [00:54:38]
...
**Mo Javad:** So Brownie is the first one that I want to quickly touch on, which is a project for Native Brownfield applications. So we talk about Brownfield as apps that are mainly native, but they're adopting some React native views and screens within them. [00:54:48]
...
**Mo Javad:** And somebody's, you know, trying to standardize and create a project and a tool for that, which is sort of less touched on in the open source ecosystem for React Native. The second library that they released, which they didn't actually start but they've now taken over is one called Voltra. So Voltra was actually created by this open source author who nobody really knew that well in the React native ecosystem. And he just kind of did it as a side project. And I think the call stack folks have kind of taken over it. So it's for things like live activities and widgets. These are sort of native functionalities that you can't really do with React native. [00:55:17]
...
**Mark Erikson:** Mm-hmm. [00:58:08]

**Mo Javad:** it. [00:58:08]

**Mark Erikson:** I know that the React compiler team has said that this is how they're hoping to try to optimize the compiler parsing phase as well. [00:58:09]
...
**Mark Erikson:** And then Joy Chung, who built the require ESM compatibility loader for node and therefore is probably gonna be more responsible for than anyone else for eliminating common js. [00:58:16]
...
**Carl Vitullo:** I was a little surprised to see this I'm not familiar with this blog, Planet performance. But it's the same domain that the Post from Alex Russell that Mark just talked about is on. So that's interesting. It's not often that I see a new blog from a recognized author, so this is interesting. It's, it looks like they're talking about web performance generally, and that's pretty cool. [00:58:53]

**Mark Erikson:** this section was like an advent of performance type thing in December. [00:59:14]

**Carl Vitullo:** Oh, that makes sense. Web performance calendar. Okay. It's like an advent calendar of web performance. Oh, that's cool. Appreciate that. [00:59:18]
...
**Carl Vitullo:** Somebody put out a blog post titled, building a JavaScript Runtime in one month. I love deep in the weeds engineering write-ups, and this is definitely one of those. But I have never even considered whether I might try to write a JavaScript runtime. [01:02:32]

And so I feel very intimidated by the scope of engineering involved in this project. but [01:02:45]

**Mark Erikson:** it even sounded like it was, you know, like, like not necessarily AI aided, at least I didn't see anything in the blog post that said they were using agents to do the work. I mean, there, there's also been a whole spate of let's have AI write a browser from scratch. Posts popping up over on Hacker News in the last month, and then I think I saw someone say they'd done a fresh browser from scratch, NC plus, but it was all by hand or something. Wow, y'all have too much time on your hands. [01:02:51]

**Carl Vitullo:** Yeah, seriously, it's impressive. I'm in awe of people who can do projects of this scope in that timescale. Like that's just wild. Anyway I approve. Very cool. [01:03:19]

**Mark Erikson:** Mm-hmm. [01:03:29]

**Carl Vitullo:** Okay, that's our lightning round. We did it. . [01:03:30]

## Conferences ([React](https://react.dev/community/conferences), [Javascript](https://confs.tech/javascript))

**Carl Vitullo:** I'm gonna blitz through a bunch of conferences. [01:03:33]
...
**Mark Erikson:** there [01:04:14]

**Carl Vitullo:** Front Runners is March 27th in Washington DC React Native Connection is March 30th and 31st in Paris. City Js London is April 15th through 17th in London. Js Day is. April 9th and 10th in Bologna, Italy. [01:04:14]
...
**Mark Erikson:** speaking there. [01:04:41]

**Carl Vitullo:** Heck yeah. I should reach out and maybe give a talk somewhere. That would be cool and good for me. There's lots more, but that's, you know, that covers the next like three months, so seems good enough for now. [01:04:42]

## Outro

**Carl Vitullo:** Thank you everyone for joining us . We not Wednesday, we are recording on Friday due to some travel hiccups, but we will be back probably on the last Wednesday of February here in the live stage react complex or back in your podcast feed just as we could, can after that. most of these sources came from Mark again. It's been very nice having such a steady stream of source of news sources come through here in Reactiflux. And maybe we'll do a little bit more to make the community more anchored on the people who are trying to stay to the cutting edge. [01:04:56]
