...
transistorId: 812669c8
audioUrl: https://op3.dev/e/media.transistor.fm/812669c8/8ebc3b9b.mp3
duration: 3133
season: 2
episode: 4
bskyPostUrl: https://bsky.app/profile/react.dev/post/3lmcp4mhmfk2l
---

- Quick hits
  - [[00:00:52](#job-market-fred-data-layoffsfyi-trueupio)] Job market: [FRED data](https://fred.stlouisfed.org/series/IHLIDXUSTPSOFTDEVE), [Layoffs.fyi](https://layoffs.fyi/), [Trueup.io](https://www.trueup.io/job-trend)
  - [[00:01:50](#conferences-react-javascript)] Conferences ([React](https://react.dev/community/conferences), [Javascript](https://confs.tech/javascript))
    - [[00:01:53](#appjs-conf-may-28-30-krakw-poland)] [App.js Conf](https://appjs.co/) May 28-30 Kraków, Poland
    - [[00:01:59](#cityjs-athens-may-27-31-athens-greece)] [CityJS Athens](https://athens.cityjsconf.org/) May 27-31 Athens, Greece
    - [[00:02:04](#react-summit-june-13-17-amsterdam-nl)] [React Summit](https://reactsummit.com/) June 13-17 Amsterdam, NL
    - [[00:02:09](#react-conf-is-back-oct-7-8)] [React Conf is back](https://bsky.app/profile/react.dev/post/3lmcp4mhmfk2l) Oct 7-8
    - [[00:02:22](#squiggleconf-2025-cfp-closes-may-23)] [SquiggleConf 2025 CFP](https://2025.squiggleconf.com/cfp) closes May 23
  - [[00:02:37](#sponsored-by-infinite-red)] [Sponsored by Infinite Red](https://infinite.red/)
  - [[00:03:24](#new-releases)] New releases
    - [[00:03:27](#animejs-v4)] [Anime.js v4](https://animejs.com/)
    - [[00:04:03](#rn-v79)] [RN v79](https://reactnative.dev/blog/2025/04/08/react-native-0.79)
    - [[00:05:00](#nextjs-153)] [Next.js 15.3](https://nextjs.org/blog/next-15-3)
    - [[00:05:20](#rspack-joins-the-nextjs-ecosystem)] [Rspack joins the Next.js ecosystem](https://rspack.dev/blog/rspack-next-partner)
    - [[00:06:29](#react-aria-april-11th)] [React Aria April 11th](https://react-spectrum.adobe.com/releases/2025-04-11.html)
    - [[00:07:13](#redux-toolkit-27)] [Redux Toolkit 2.7](https://github.com/reduxjs/redux-toolkit/releases/tag/v2.7.0)
    - [[00:07:44](#vitest-31)] [Vitest 3.1](https://github.com/vitest-dev/vitest/releases/tag/v3.1.0)
- [[00:07:55](#main-content)] Main Content
  - [[00:07:57](#react-labs-view-transitions-activity-and-more)] [React Labs: View Transitions, Activity, and more](https://react.dev/blog/2025/04/23/react-labs-view-transitions-activity-and-more)
  - [[00:22:04](#react-191)] [React 19.1](https://github.com/facebook/react/releases/tag/v19.1.0)
    - [[00:22:53](#one-react-mistake-thats-slowing-you-down)] [One React mistake that's slowing you down](https://www.epicreact.dev/one-react-mistake-thats-slowing-you-down)
    - [[00:26:12](#advanced-react-component-patterns)] [Advanced React Component Patterns](https://kentcdodds.com/blog/advanced-react-component-patterns)
    - [[00:26:54](#improvements-in-expo-using-owner-stack)] [Improvements in Expo using owner stack](https://github.com/expo/expo/pull/35866)
  - [[00:27:48](#dan-abramov-is-writing-again)] Dan Abramov is writing again
    - [[00:29:09](#react-for-two-computers-complement-to-his-react-conf-talk)] [React for Two Computers](https://overreacted.io/react-for-two-computers/) (Complement to [his React Conf talk](https://www.youtube.com/watch?v=ozI4V_29fj4))
    - [[00:29:26](#jsx-over-the-wire)] [JSX Over The Wire](https://overreacted.io/jsx-over-the-wire/)
    - [[00:30:11](#impossible-components)] [Impossible Components](https://overreacted.io/impossible-components/)
    - [[00:35:28](#dont-ruin-his-process)] [don’t 👏 ruin 👏 his 👏 process](https://bsky.app/profile/danabra.mov/post/3lmi3gpiluk2m)
- [[00:35:47](#-lightning-round-)] ⚡ Lightning round ⚡
  - [[00:35:48](#nextjs-rfc-deployment-adapters-api)] [Next.js RFC: Deployment Adapters API](https://github.com/vercel/next.js/discussions/77740)
  - [[00:36:23](#flightcontroldev-from-last-year-secret-knowledge-to-self-host-nextjs)] flightcontrol.dev from last year: [Secret knowledge to self-host Next.js](https://www.flightcontrol.dev/blog/secret-knowledge-to-self-host-nextjs)
  - [[00:36:38](#styled-components-in-maintenance-mode)] [Styled-Components in maintenance mode](https://opencollective.com/styled-components/updates/thank-you)
  - [[00:37:15](#rip-styled-components-now-what)] [RIP Styled-Components. Now What?](https://fadamakis.com/rip-styled-components-now-what-a8717df86e86)
  - [[00:38:50](#redwood-announces-new-cloudflare-based-rsc-sdk-existing-framework-in-community-maintenance-mode)] [Redwood announces new Cloudflare-based RSC SDK](https://redwoodjs.com/), existing framework in community maintenance mode
  - [[00:40:18](#tc39-kills-records-and-tuples-proposal-possible-alternative-is-composites)] TC39 kills [Records and Tuples proposal](https://github.com/tc39/proposal-record-tuple/issues/394). Possible alternative is [“Composites”](https://github.com/tc39/proposal-composites)
  - [[00:41:36](#react-compiler-rc)] [React Compiler RC](https://react.dev/blog/2025/04/21/react-compiler-rc)
  - [[00:42:29](#just-use-vite-with-the-workers-runtime-vite-on-cloudflare)] ["Just use Vite”… with the Workers runtime](https://blog.cloudflare.com/introducing-the-cloudflare-vite-plugin/) (Vite on Cloudflare)
  - [[00:44:21](#silk-library---native-like-swipeables-for-the-web)] [Silk Library - native-like swipeables for the web](https://silkhq.co/)
  - [[00:45:22](#transitions-fstate)] [\{transitions\} = f(state)](https://jordaneldredge.com/blog/transitions-f-of-state/)
  - [[00:45:51](#tailwind-4-bun-and-old-macs-a-supermarket-bag-and-a-truckload-of-fomo)] Tailwind 4, Bun, and old Macs: [A Supermarket Bag And a Truckload Of FOMO](https://blog.julik.nl/2025/03/a-little-adventure-in-modern-frontend)
  - [[00:46:47](#introducing-firebase-studio)] [Introducing Firebase Studio](https://firebase.blog/posts/2025/04/introducing-firebase-studio/)
  - [[00:49:05](#gumroad-is-open-source)] [Gumroad is open source!](https://gumroad.gumroad.com/p/gumroad-is-now-open-source)
  - [[00:49:50](#automattic-laid-off-16-of-staff)] [Automattic laid off 16% of staff](https://automattic.com/2025/04/02/restructuring-announcement/)

# Transcript

**Carl Vitullo:** Thank you for joining us for the April edition of this month in React, where we recap and digest the recent developments in the ever-evolving reactive web ecosystem. [00:00:07]
...
**Mark Erikson:** I'm Mark. My day job is working at Replay io and in my free time I spend entirely too much stuff and time working on Redux and griping about the React docs. [00:00:39]

**Mo Javad:** And I am Mo, I had the mobile team at Theodo. And I am an active member of the React Native ecosystem and organized the React Native London Meetup and the React Native London Conference. Happy to be here as always. [00:00:51]

**Carl Vitullo:** Heck yeah. [00:00:52]
...
**Carl Vitullo:** Very quick overview of job market stuff. I found a new data source that I don't know how I hadn't heard of it before 'cause it is not super new. trueup.io has a job trend page that looks pretty good. similar but distinct from layoffs.fyi. [00:01:05]
...
**Carl Vitullo:** So upcoming conferences in May! [00:01:53]

## [App.js Conf](https://appjs.co/) May 28-30 Kraków, Poland

**Carl Vitullo:** At the end of May, May 28th through 30th in Krakow Poland, we have App.Js conference [00:01:59]

## [CityJS Athens](https://athens.cityjsconf.org/) May 27-31 Athens, Greece

**Carl Vitullo:** . There's also City JS Athens around the same time. May 27th through 31st. [00:02:04]

## [React Summit](https://reactsummit.com/) June 13-17 Amsterdam, NL

**Carl Vitullo:** Then in June we've got a React Summit in Amsterdam. [00:02:09]

## [React Conf is back](https://bsky.app/profile/react.dev/post/3lmcp4mhmfk2l) Oct 7-8

**Carl Vitullo:** This is very early, but the React core team has announced that React Conf will be back this year. last year. It was when I was in May. this time last year I was in Vegas for that, but yeah, they're doing it you know, mid-October. So that's cool. [00:02:22]

## [SquiggleConf 2025 CFP](https://2025.squiggleconf.com/cfp) closes May 23

**Carl Vitullo:** there's an open CFP that closes one month from now for squiggle conf, which I am on staff for. if you would like to maybe speak at a conference. It's a great conference. I love it. It's organized by a, you know, a good buddy of mine. Yeah, definitely check that out. [00:02:37]

## [Sponsored by Infinite Red](https://infinite.red/)

**Carl Vitullo:** And of our sponsor read, we are sponsored solely right now by Infinite Red, which is an expert React native consultancy that's been around since 2015. [00:02:46]
...
**Carl Vitullo:** Okay, running through some new releases. [00:03:27]

## [Anime.js v4](https://animejs.com/)

**Carl Vitullo:** This is only tangentially react related, but anime js a animation library, or they describe it as an animation engine. Just had a V four release and the website is super slick. Definitely a phenomenal advertisement for what you can do with the tool. [00:03:46]
...
**Carl Vitullo:** Yeah. Very cool. I saw this is their third release this year, whereas in the past , they've generally done like three releases in any given year, [00:04:48]

**Mo Javad:** I think the trend is going towards doing a release every two months or so. [00:04:52]

**Mark Erikson:** That's a pretty solid cadence. [00:04:54]

**Mo Javad:** Yeah. I think they've really taken a lot of steps over the last two years to try to bring down that release time and it's starting to pay off. [00:05:00]

## [Next.js 15.3](https://nextjs.org/blog/next-15-3)

**Mark Erikson:** Next 15.3 is out. Biggest news for this one is they now have alpha level support for using the turbo pack bundler for production builds. Previously, it had only been available for dev mode. So it looks like there's alpha level version for that. they have it passing most of their tests, but it's apparently not ready yet. [00:05:20]

## [Rspack joins the Next.js ecosystem](https://rspack.dev/blog/rspack-next-partner)

**Mark Erikson:** Also 15.3 now has support for optional using the third party RS Pac Bundler. I. For builts RS Ppac is a rust based re-implementation of Webpac and basic compatible with web pack's configs. So given that the existing version of Next still uses Webpac under the hood, the next and web and RS Ppac teams were able to collaborate and figure out how to get a plugin that would essentially allow it to use RsPack instead of Webpack as one possible alternative way to try to speed things up. [00:05:55]

**Carl Vitullo:** Yeah, I did see that the performance improvement from using RsPack and Next is like not that great and like in some circumstances could actually be worse than Webpac, which seems confusing to me. [00:06:07]

**Mark Erikson:** some of it was due to things like JS based plugins and, and some of the, the interrupt back and forth between. Uhland and JS land. [00:06:16]

**Carl Vitullo:** Right. I mean, hey, similar problem is how React Native had with the, parsing data back and forth. kind of goes to show you how even once you have a tool that is written in native, it's, you know, it's not a silver bullet. It doesn't fix all the problems. [00:06:29]

## [React Aria April 11th](https://react-spectrum.adobe.com/releases/2025-04-11.html)

**Carl Vitullo:** Yeah, react Aria by Adobe had a release. [00:06:32]
...
**Mark Erikson:** Last week I shipped Redux Toolkit 2.7 as I was on my flight to React Miami. [00:07:18]
...
**Carl Vitullo:** That's super cool. I love generated types. [00:07:44]

## [Vitest 3.1](https://github.com/vitest-dev/vitest/releases/tag/v3.1.0)

**Mark Erikson:** And then Vitest 3.1 is out. Doesn't look like there's a, a huge standout feature, but a, a bunch of, again, small fixes and performance improvements, obligatory. [00:07:55]

## Main Content

**Carl Vitullo:** Yeah, into our main content. [00:07:57]
...
**Carl Vitullo:** So conveniently, like 35 minutes ago, the core team put out a new blog post a new React Labs post. React Labs are posts where they write about projects in active research and development. So this is like, definitely, this is like, you know, leading edge. What is the core team working on? [00:08:14]
...
**Mark Erikson:** Yeah, that, that makes sense. And I can definitely see how something like that would be difficult to do in React, where, you know, normally you stop rendering A and you start rendering B. [00:10:32]
...
**Carl Vitullo:** this like scratch an itch in the back of my brain because it, I, remember talking about this previously, so I was just googling like the, you know, offscreen and oh my God, like they've, they've been talking about this in both of the last two labs posts that we just mentioned. [00:12:50]
...
**Carl Vitullo:** Yeah. it feels like a documentation problem. I feel like so many people are learning, react from a mishmash of strange places that they're learning, not what the core team would like. And you fix that by writing really good docs. [00:16:00]

**Mark Erikson:** So anyway, the ul ultimately they're trying to work towards making the compiler be able to insert all those dependencies for you, and then maybe someday we get to stop thinking about this entirely. [00:16:08]
...
**Carl Vitullo:** Right. I've never used used sync external store, partly because of the warnings they gave of like, this is gonna break stuff. So yeah. That's interesting. That's cool. [00:18:12]
...
**Mark Erikson:** will say that I've, I've watched them put up and merge several prs that are input, are trying to implement fragment refs. So it's, it's definitely not just a theoretical research project. They're actively trained to work out the implementation deals and details. At the moment, [00:19:33]

**Carl Vitullo:** That makes sense. Yeah. [00:19:34]
...
**Carl Vitullo:** Kent C Dodds, put out a, you know, one react mistake that's slowing you down blog post a while back and it talks about like component composition and like how you structure the tree and it doesn't name owner stack. [00:23:07]
...
**Mark Erikson:** I will caveat that one. [00:24:40]
...
**Carl Vitullo:** Right, right. I guess let, yeah, maybe I'll, I'll revise that a little bit. So it's at that root level, if the root level component is re rendering, sure. All of the children still need to re-render, but the deeper the tree, the more parents that're in the loop there are. So this has been like moving components so that it's, the owner tree is flatter, has been like the number one, general approach I've done when there are performance problems in a code base, , which generally comes from, like, you can think in smaller units. I don't know. feel like I'm going deep in the weeds and not stating anything clearly. [00:26:07]

**Mark Erikson:** generally speaking Composition is a good thing that more developers would benefit from taking advantage of. [00:26:12]

## [Advanced React Component Patterns](https://kentcdodds.com/blog/advanced-react-component-patterns)

**Carl Vitullo:** Yeah. Another, old, old old post that I'll just shout out. Uh, again had a phenomenal post from 2017 talking about advanced react component patterns and like, okay, some of these are no longer like super duper relevant anymore, like higher aortic components. [00:26:27]
...
**Mark Erikson:** Yep. [00:26:52]

**Carl Vitullo:** Anyway, super cool to see it surfaced. [00:26:54]

## [Improvements in Expo using owner stack](https://github.com/expo/expo/pull/35866)

**Mo Javad:** one of the things that this owner stack, change is actually powering is some updates to the expo CLI for when you run your app in dev mode because one of the challenges in the React native world is that you get these massive log, massive log spans. [00:27:10]
...
**Carl Vitullo:** Okay. That's all we got for React 19.1. Really. I don't know. There's just, there's not that much in 19.1. [00:27:48]

## Dan Abramov is writing again

**Carl Vitullo:** This is kind of small, this is maybe just like commenting on the ecosystem, but Dan Abramov is writing again, and That's nice. He was writing a lot. I don't know how many hours of text do you think he's written, mark? [00:28:00]

**Mark Erikson:** Many, many hours. Like I, I read fairly fast and there, there is a lot of content there. [00:28:06]

**Carl Vitullo:** One of the newsletters I subscribed to that shared this out you know, does share estimated reading time. And it was, you know, one of the posts was estimated reading time of an hour. And like, that's just if you're scanning your eyes over the words, I think, not trying to digest and understand it, but like broadly what he's writing about is server components. [00:28:25]

**Mark Erikson:** Dan is fascinated with server components at like a technical concept, architectural. Where did this come from? How did we get here? What does this, how is this similar to old approaches? How is this different? What does it enable that you couldn't do before, kind of a level. [00:28:47]
...
**Carl Vitullo:** And I also wanted to shout out a blog post from October of last year from Brandon Bayer of Flight Control, secret Knowledge to Self-Host Next js. [00:36:33]
...
**Mark Erikson:** I would not have thought about that. [00:38:50]

## [Redwood announces new Cloudflare-based RSC SDK](https://redwoodjs.com/), existing framework in community maintenance mode

**Carl Vitullo:** Redwood has announced that they are now doing a CloudFlare based react server components, SDK. So like they used to be more of a framework and now they're like, it's kind of a reduced scope. I don't know. This connects back to, part of the headline of our January episode was "RedwoodJS, dead?" [00:39:12]
...
**Mark Erikson:** Last month we announced one of the major pieces of news was a vulnerability in Next's middleware implementation that could potentially have author related concerns. And there was a, you know, a major CVE vulnerability announced around that. This month it was react routers turn something was announced to have to do with some of the the path parsing definitions. [00:44:12]

There are fixes out for both React Rider and remix. Please upgrade appropriately. [00:44:17]

**Carl Vitullo:** Yeah, this one looks a lot less major than the next one, but yeah, they did get a CVE. [00:44:21]

## [Silk Library - native-like swipeables for the web](https://silkhq.co/)

**Mo Javad:** So next up, I just a library that I saw floating about in the, blue Sky and Twitterverse. Silk is a pretty cool library that takes in sort of these like native swipeable sheets that you're used to in the native world and brings it to the web in a React library. [00:44:37]
...
**Mark Erikson:** And then tossing out one more There was a very interesting article from someone who is trying to switch from using Tailwind three to Tailwind four. [00:45:58]
...
**Mo Javad:** It's kind of poetic in some. [00:50:53]

**Carl Vitullo:** it would feel more like poetic justice if Matt was the one losing his job. [00:50:56]

Not people unrelated, but Yes. Ugh. [00:50:59]

**Mo Javad:** But you know, I, I, I hope that other tech executives think twice and it becomes a learning lesson before they try to take open source products and monetize it in their favor when they have control over an ecosystem. I hope that people uh, think twice after this. [00:51:15]

**Carl Vitullo:** Yeah, right. I feel like this is gonna be some kind of business case study somewhere. So that's, you know, hopefully [00:51:20]

**Mo Javad:** I hope he also loses any bonuses that he was banking on getting this year [00:51:24]

**Carl Vitullo:** anyway, That's all we got for you this month. Thank you so much for joining us. We will be back on the last Wednesday of the month, next month here in the live stage or back in your podcast feed just as soon as we can. [00:51:34]
...
**Mo Javad:** See you all next month.
